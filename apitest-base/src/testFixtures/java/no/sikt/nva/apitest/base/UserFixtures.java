...
public final class UserFixtures {
  public static final User UIB_CREATOR = User.builder()
  ...
  public static final User UIB_PUBLISHING_CURATOR = User.builder()
  ...
  public static final User UIB_NVI_CURATOR = User.builder()
  ...
  public static final User UIB_SUPPORT_CURATOR = User.builder()
  ...
  public static final User UIB_DOI_CURATOR = User.builder()
  ...
  public static final User UIB_EDITOR = User.builder()
  ...
  public static final User UIB_CONTRIBUTOR = User.builder()
  ...
  public static final User UIB_THESIS_CURATOR = User.builder()
  ...
  public static final User KRISTIANIA_CREATOR = User.builder()
  ...
  public static final User KRISTIANIA_PUBLISHING_CURATOR = User.builder()
  ...
  public static final User KRISTIANIA_NVI_CURATOR = User.builder()
  ...
  public static final User KRISTIANIA_EDITOR = User.builder()
  ...
  public static final User OSLO_MET_CREATOR = User.builder()
  ...
  public static final User OSLO_MET_PUBLISHING_CURATOR = User.builder()
  ...
  public static final User OSLO_MET_NVI_CURATOR = User.builder()
  ...
  public static final User OSLO_MET_EDITOR = User.builder()
  ...
  public static final User UIS_CREATOR = User.builder()
  ...
  public static final User UIS_NVI_CURATOR = User.builder()
  ...
  public static final User UIS_PUBLISHING_CURATOR = User.builder()
  ...
  public static final User UIS_EDITOR = User.builder()
