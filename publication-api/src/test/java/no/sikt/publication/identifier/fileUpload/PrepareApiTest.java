...
class PrepareApiTest extends FileUploadTestBase {
    ...
    void shouldReturnUploadUrlWhenPrepareFile() {
        ...
        var preparePayload = Map.of(NUMBER, "1", UPLOAD_ID, uploadId, KEY, key, BODY, getFileAsString());
    ...
    void shouldReturnBadRequestWhenPrepareFileWithoutCreate() {
        var identifier = PUBLICATION_FACTORY
                ...
                .jsonPath()
                .getString(IDENTIFIER);
        var preparePayload = Map.of(NUMBER, "1", UPLOAD_ID, "dummyUploadId", KEY, "dummyKey", BODY, getFileAsString());
